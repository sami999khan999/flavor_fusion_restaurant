...
class App {
    ...
    _getBurgersData() {
        (0, _dateJs.burgers).forEach((burger)=>this._renderBurgers(burger));
    }
        ...
        const html = `
          ...
          >
            ...
            <div class="burger-text p-5 flex flex-col items-start gap-2">
              ...
              <p class="text-xl font-semibold text-orange-500">${this._currencyConverter(burger.price)}</p>
...
},{"./date.js":"bypXa"}],"bypXa":[function(require,module,exports) {
...
},{}]},["igKGj","8lqZg"], "8lqZg", "parcelRequire5cdd")
